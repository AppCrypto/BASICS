...
func main() {
	...
	fmt.Printf("ABEKeyGen time cost: %v μs ", (endts-startts)/times)
	fmt.Println("........")
	...
	endts = time.Now().UnixNano() / 1e3
	fmt.Printf("GenProofs time cost: %v μs ", (endts-startts)/times)
	fmt.Println("........")
	...
	endts = time.Now().UnixNano() / 1e3
	fmt.Printf("CheckKey time cost: %v μs ", (endts-startts)/times)
	fmt.Println("........")
	...
	endts = time.Now().UnixNano() / 1e3
	fmt.Printf("GetKey time cost: %v μs ", (endts-startts)/times)
	fmt.Println("........")
